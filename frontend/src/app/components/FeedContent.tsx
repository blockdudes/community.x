...
import { Heart, MessageCircle, Send, MoreVertical, Image as ImageIcon, X } from 'lucide-react'

interface FeedContentProps {
  selectedSpace: any;
}

  function FeedContent({ selectedSpace }: FeedContentProps) {
    ...
    // Specify that commentingOn can be either a number or null
            ...
            <CardContent className="p-3">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <Button variant="ghost" size="sm" className="text-[10px]" onClick={() => setCommentingOn(current => current === post.id ? null : post.id)}>
